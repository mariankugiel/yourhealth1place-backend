-- Complete fix for user_notifications table
...
UPDATE user_notifications SET created_at = NOW() WHERE created_at IS NULL;
UPDATE user_notifications SET updated_at = NOW() WHERE updated_at IS NULL;
...
-- Expected output: All notification preference columns
