terraform {
  ...
  # Terraform Cloud Configuration for Development
  cloud {
...
module "iam" {
  ...
  environment = var.environment
  project_name = var.project_name
  health_data_bucket_name = var.health_data_bucket_name
...
module "ec2" {
  ...
  application_security_group_id = module.vpc.application_security_group_id
