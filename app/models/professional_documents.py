...
class ProfessionalDocument(Base):
    ...
    document_metadata = Column(JSON)  # Additional metadata (form fields, template variables, etc.)
...
class ProfessionalDocumentAssignment(Base):
    ...
    document = relationship("ProfessionalDocument", back_populates="assignments")
...
class ProfessionalDocumentShare(Base):
    ...
    # Relationships
    document = relationship("ProfessionalDocument", backref="shares")
...
class ProfessionalDocumentAccessLog(Base):
    ...
    # Relationships
    document = relationship("ProfessionalDocument", backref="access_logs")
