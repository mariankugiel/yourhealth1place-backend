...
class Professional(Base):
    ...
    practices = relationship("ProfessionalPractices", back_populates="professional")
    availability_schedules = relationship("ProfessionalAvailabilitySchedules", back_populates="professional")
    appointment_slots = relationship("ProfessionalAppointmentSlots", back_populates="professional")
    pricing = relationship("AppointmentTypePricing", back_populates="professional")
    manual_appointments = relationship("ManualAppointments", back_populates="professional")
    documents = relationship("ProfessionalDocuments", back_populates="professional")
    document_templates = relationship("ProfessionalDocumentTemplates", back_populates="professional")
    document_instances = relationship("ProfessionalDocumentInstances", back_populates="professional")
    appointments = relationship("Appointments", back_populates="professional")
